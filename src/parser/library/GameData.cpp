...
{
#	define tSelf ScriptParser::TYPE_GAMEDATA
...
Library::GameData& Library::GameData::instance()
{
	static Library::GameData instance(REFGAMEDATA, table);
	return instance;
}

void Library::GameData::generateFunctionCode(
		LinkTable* linktable,
