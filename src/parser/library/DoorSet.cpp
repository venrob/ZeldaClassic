...
{
#	define tSelf ScriptParser::TYPE_DOORSET
...
Library::DoorSet& Library::DoorSet::instance()
{
	static Library::DoorSet instance(REFDOORS, table);
	return instance;
}

void Library::DoorSet::generateFunctionCode(
		LinkTable* linktable,
