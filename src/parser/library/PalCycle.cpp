...
{
#	define tSelf ScriptParser::TYPE_PALCYCLE
...
Library::PalCycle& Library::PalCycle::instance()
{
	static Library::PalCycle instance(REFPALCYCLE, table);
	return instance;
}

void Library::PalCycle::generateFunctionCode(
		LinkTable* linktable,
