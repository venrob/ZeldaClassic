...
{
#	define tSelf ScriptParser::TYPE_ZUICOLOURS
...
Library::MiscColor& Library::MiscColor::instance()
{
	static Library::MiscColor instance(REFUICOLOURS, table);
	return instance;
}

void Library::MiscColor::generateFunctionCode(
		LinkTable* linktable,
